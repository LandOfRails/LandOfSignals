...
public class ContentPackSignalbox {
    ...
    public static ContentPackSignalbox fromJson(InputStream inputStream) {
        ...
        try {
            ...
            throw new ContentPackException("Cant read ContentPackSignalbox: " + e.getMessage());
        }

        String json = s.toString();
        return GSON.fromJson(json, ContentPackSignalbox.class);
    }
