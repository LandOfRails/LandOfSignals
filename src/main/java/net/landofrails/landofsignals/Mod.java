...
@net.minecraftforge.fml.common.Mod(modid = Mod.MODID, name = "LandOfSignals", version = "1.0.0", dependencies = "required-after:universalmodcore@[1.1,1.2)", acceptedMinecraftVersions = "[1.12,1.13)")
