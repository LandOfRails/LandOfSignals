...
public class LOSBlocks {
    ...
    public static final BlockSignalPart BLOCK_SIGNAL_PART_GAMERTV_HVHP = new BlockSignalPart("block_signal_part_gamertv_hvhp", "models/block/landofsignals/gamertv/kopf/hv_hp.obj", new Vec3d(0.5, 0, 0.5), new Vec3d(1, 1, 1), new ArrayList<String>() {{
        add(null);
        add("hp1");
        add("hp2");
        add("sh1");
    ...
    public static final BlockSignalPart BLOCK_SIGNAL_PART_GAMERTV_HVERSATZ = new BlockSignalPart("block_signal_part_gamertv_hversatz", "models/block/landofsignals/gamertv/ersatzsignal/hv_ersatzsignal.obj", new Vec3d(0.5, 0, 0.5), new Vec3d(1, 1, 1), new ArrayList<String>() {{
        add(null);
        add("an");
    }});
